...
def calmar(DF): #measure of risk adjusted return
    df = DF.copy()
...
for ticker in ohlcv_data:
    ...
    print("Sharpe for {} = {}".format(ticker,Sharpe_ratio(ohlcv_data[ticker])))
    print("Sortino for {} = {}".format(ticker,sortino(ohlcv_data[ticker])))
    print("Max Drawdown for {} = {}".format(ticker,max_dd(ohlcv_data[ticker])))
